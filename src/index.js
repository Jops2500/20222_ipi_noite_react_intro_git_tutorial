...
const App = () => {
  ...
  return (
    ...
    <label classname="rotulo" htmlFor="nome" style={{diplay: 'block', marginBotton: 4}}>{textoDoRotulo}</label>
    <input type="text" id='nome' style={{paddingTop: 8, paddingBotton: 8, borderStyle:'hidden', 
